...
public class MethodArgumentNotValidException extends RuntimeException implements Serializable {

    private static final long serialVersionUID = 1L;

    public MethodArgumentNotValidException(int statusCode, String message, String code) {
        super(message);
