...
public class CacheDataNotFoundException extends RuntimeException implements Serializable {

    private static final long serialVersionUID = 1L;

    public CacheDataNotFoundException(int statusCode, String message, String code) {
        super(message);
